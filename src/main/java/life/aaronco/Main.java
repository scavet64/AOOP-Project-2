package life.aaronco;

import life.GameOfLife.*;
import life.Genetic.*;
import life.Genetic.Bitset.BitsetCrossoverRandom;
import life.Genetic.Bitset.BitsetGeneticAlgorithm;
import life.Genetic.Bitset.BitsetSample;
...
public class Main {
    ...
    public static void main(String[] args) {
        Board gb =  new life.GameOfLife.WrappedBoard(128, 128, new ConwaysCellRules());
